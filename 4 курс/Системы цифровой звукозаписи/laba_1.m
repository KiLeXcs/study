...
function sampling = sample(x, r, t, s_0, name, f_signal)
   ...
   global freq;
   disp("------------------------------------------------------------------------");
   disp("Now freq of sampling = " + num2str(length(t)) + " Hz, r = " + num2str(r));
   disp("Signal is " + name);
   ...
   Psh = sum(abs(z_0-s_0).^2/length(z_0));
   SNR = 10 * log10(Pc/Psh);
   ...
   hold on;
   plot(t_start, s_0, 'r-', 'LineWidth', 1);
   hold off;
   grid on;
   ylim([-2 2]);
   xlim([0 100/f_signal]);
