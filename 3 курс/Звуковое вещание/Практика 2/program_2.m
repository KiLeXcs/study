...
title("График мгновенных спектров испытательного сигнала")
%axis([10^(0) 10^(2.3) -300 0])
xlabel("отсчет частоты")
ylabel("амплитуда")
legend('испытательный сигнал','сигнал скользящего тона','белый шум','спокойный голос','шепот','эмоциональный голос')
grid on
%Построение графиков текущего и энергетического спектров исптытательного сигнала
subplot(2,1,2)
semilogx(t,StdBSF,t,SrmsdBFS,t,StdBSF1,t,SrmsdBFS1,t,StdBSF2,t,SrmsdBFS2);
title("График текущего и энергетического спектров испытательного сигнала")
xlabel("отсчет частоты")
ylabel("амплитуда")
legend('Текущий спектр испытательного сигнала','Энергетический спектр испытательного симигнала','Текущий спектр сигнала скользящего тона','Энергетический спектр сигнала скользящего тона','Текущий спектр белого шума','Энергетический спектр белого шума')
grid on
%Сформирование графическое окно и координатные оси
figure
hold on
...
subplot(3,1,1)
specgram(xrec,N)
title("Спектрограмма звукового сигнала спокойным голосом")
colormap;
colorbar;
xlabel("Массив, содержащего отсчеты синусодального сигнала")
ylabel("Длина БПФ")
grid on
subplot(3,1,2)
specgram(yrec,N)
title("Спектрограмма звукового сигнала шепотом")
colormap;
colorbar;
xlabel("Массив, содержащего отсчеты синусодального сигнала")
ylabel("Длина БПФ")
...
subplot(3,1,3)
specgram(zrec,N)
title("Спектрограмма звукового сигнала эмоциональным голосом")
colormap;
colorbar;
xlabel("Массив, содержащего отсчеты синусодального сигнала")
ylabel("Длина БПФ")
